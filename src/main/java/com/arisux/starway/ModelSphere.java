...
//        if (!invert)
        {
            Draw.buffer().begin(GL11.GL_TRIANGLE_FAN, DefaultVertexFormats.POSITION_TEX_NORMAL);
            Draw.buffer().pos(v3.x, v3.y, v3.z).normal(nX, nY, nZ).color(this.color.r, this.color.g, this.color.b, this.color.a).endVertex();// flipped these
            Draw.buffer().pos(v2.x, v2.y, v2.z).normal(nX, nY, nZ).color(this.color.r, this.color.g, this.color.b, this.color.a).endVertex();// flipped these
            Draw.buffer().pos(v1.x, v1.y, v1.z).normal(nX, nY, nZ).color(this.color.r, this.color.g, this.color.b, this.color.a).endVertex();// flipped these
