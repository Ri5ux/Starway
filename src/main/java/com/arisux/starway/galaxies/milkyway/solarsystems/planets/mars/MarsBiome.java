...
{
    public static MarsBiome mars = (MarsBiome) new MarsBiome(new BiomeProperties("Mars").setBaseHeight(0.2F).setHeightVariation(0.5F).setTemperature(0.25F).setRainDisabled()).setRegistryName(Starway.ID, "mars");
